...
if [ ! -e "/etc/csf/csf.conf" ]; then
	cp -avf conf/cwp/csf.conf /etc/csf/csf.conf
fi
...
if [ ! -e "/etc/csf/csf.allow" ]; then
	cp -avf conf/cwp/csf.allow /etc/csf/csf.allow
fi
...
if [ ! -e "/etc/csf/csf.ignore" ]; then
	cp -avf conf/cwp/csf.ignore /etc/csf/csf.ignore
fi
if [ ! -e "/etc/csf/csf.pignore" ]; then
	cp -avf conf/cwp/csf.pignore /etc/csf/csf.pignore
fi
...
cp -avf conf/cwp/csf.conf /usr/local/csf/profiles/reset_to_defaults.conf
